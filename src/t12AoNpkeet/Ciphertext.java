...
public class Ciphertext {
    ...
    Ciphertext(Message m, PublicPrivateKeyPair ppkp) {
        ...
        C2 = ParamsA.g.powZn(v).getImmutable();
        ...
        byte[] C4_hash = utils.HashUtils.notSafeHash(32, ppkp.pk_y.powZn(v).toString());
        C4 = ParamsA.g.powZn(ParamsA.Zr.newElementFromBytes(C4_hash)).mul(ParamsA.g.powZn(m.mElement));
